...
# data_dict = mat['jain']  # Replace 'your_variable_name' with the actual variable name in the .mat file
...
cluster_labels = vdbscan.fit_predict(jain)

# Create a scatter plot to visualize the clusters
plt.scatter(jain[:, 0], jain[:, 1], c=cluster_labels, cmap='viridis')
plt.title('VariationalDBSCAN Clustering of Dataset "jain"')
plt.xlabel('Feature 1')
plt.ylabel('Feature 2')
